...
//!
//! - [`local`] — ionic local potential V_local(r), assembled from the
//!   pseudopotential's V_local(G) via Bessel transform.
//! - [`nonlocal`] — Kleinman-Bylander separable non-local projectors,
//!   arbitrary angular momentum l via spherical-harmonic recurrence.
//! - [`xc`] — exchange-correlation functionals (LDA today; GGA, hybrid
//!   in progress) with dispatch over spin and functional choice.
//!
