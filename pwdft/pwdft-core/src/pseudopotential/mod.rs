...
mod tests {
    ...
    fn si_pp_path() -> PathBuf {
        PathBuf::from(env!("CARGO_WORKSPACE_DIR")).join("pseudopotentials/nc/lda/Si.upf")
    }
    ...
    #[test]
    fn test_load_fe_upf() {
        let path = PathBuf::from(env!("CARGO_WORKSPACE_DIR")).join("pseudopotentials/nc/lda/Fe.upf");
    ...
    #[test]
    fn test_load_c_upf() {
        let path = PathBuf::from(env!("CARGO_WORKSPACE_DIR")).join("pseudopotentials/nc/lda/C.upf");
        let pp = load(&path).unwrap();
