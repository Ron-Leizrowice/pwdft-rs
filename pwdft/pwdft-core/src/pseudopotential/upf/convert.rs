...
mod tests {
    ...
    // (`validation/src/pwdft_validation/scripts/rho_core_g_reference.py`, which parses the UPF
    ...
    ///
    /// Reference: `validation/src/pwdft_validation/scripts/rho_core_g_reference.csv` row
    ...
    /// `validation/src/pwdft_validation/scripts/rho_core_g_reference.csv` row `(si, shell 1)`
    ...
    /// `validation/src/pwdft_validation/scripts/rho_core_g_reference.csv` row `(fe, shell 0)`
    ...
    /// `validation/reference/qe/cu_fcc_scf.in`).
    /// Reference: `validation/src/pwdft_validation/scripts/rho_core_g_reference.csv` row
