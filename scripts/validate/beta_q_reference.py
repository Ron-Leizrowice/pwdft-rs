...
Run
---
    uv run scripts/validate/beta_q_reference.py
"""
...
def main() -> int:
    ...
    out_csv = repo_root / "scripts" / "validate" / "beta_q_si_reference.csv"
    ...
    print(
        f"q-grid: {N_Q} values in [{Q_MIN_BOHR}, {Q_MAX_BOHR}] Bohr⁻¹"
    )
